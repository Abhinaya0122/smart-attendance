...
class Face_Register:
    ...
    # Create the parent directory and subdirectory if they don't exist
        ...
        # You may want to handle the error appropriately (e.g., logging, printing, or raising an exception)

    # Check if the directory was created successfully
        if os.path.isdir(self.path_photos_from_camera):
            print(f"Directory '{self.path_photos_from_camera}' created successfully.")
        else:
            print(f"Failed to create directory '{self.path_photos_from_camera}'.")
